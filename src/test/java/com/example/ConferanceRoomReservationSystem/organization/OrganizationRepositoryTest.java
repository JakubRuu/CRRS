...
import com.example.ConferanceRoomReservationSystem.organization.args.GetAllOrganizationArgumentProvider;
import com.example.ConferanceRoomReservationSystem.organization.args.GetByIdOrganizationArgumentProvider;
...
class OrganizationRepositoryTest {
    ...
    void when_arg_0_date_are_available_in_repo_then_find_all_should_return_arg_1_list(List<Organization> arg0,
    ...
    void when_find_by_arg_1_when_arg_0_list_is_availavle_then_arg_2_item_should_be_returned(List<Organization> arg0,
                                                                                            String arg1,
    ...
    void when_save_arg_0_with_wrong_primary_key_then_exception_should_be_thrown() {
        //given
        Organization arg0 = new Organization(null, "IT comapany");
        //when
        //then
